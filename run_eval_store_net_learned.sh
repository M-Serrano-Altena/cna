...
#SBATCH --job-name=EvaluationStoreNetLearned
#SBATCH --partition=gpu_a100
#SBATCH --output=output_eval_store_net_learned.out
#SBATCH --gres=gpu:1
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
singularity exec --nv \
    ...
    python3 src/main_evaluation.py net-fragments_learn_s1\
        ...
        --store_baseline_activations_path "activations/net-fragments_learn_s1_baseline_activations.pt" \